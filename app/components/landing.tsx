    ...
    return (
        ...
        <section id="landing" className="relative md:grid col-span-full grid-cols-1 md:grid-cols-9 md:gap-6 h-screen w-full">
            ...
            <div className="mt-5 md:hidden h-fit">
                ...
                <h1 className="font-bold mb-2 text-left text-7xl leading-[0.65] my-0 stroked appear-left text-[#111010] dark:text-white" dir="ltr">FOKKKK.</h1>
            </div>
            ...
            <div className="mt-[20rem] md:mt-0 md:col-span-5 h-full">
                <div className="p-3 md:grid md:grid-cols-2 md:h-full h-fit relative grid-flow-row auto-rows-max">
                    <div className="col-span-2 h-fit hidden md:block">
                        <h1 className="font-bold mt-3 mb-4 text-right text-xxl line-h leading-[0.65] appear-right text-[#111010] dark:text-white" dir="rtl">JONAS</h1>
                        <h1 className="font-bold mt-3 mb-2 text-right text-xxl leading-[0.65] my-0 stroked appear-right hidden md:hidden lg:block text-[#111010] dark:text-white" dir="rtl">.FOKKKKKK</h1>
                        <h1 className="font-bold mb-2 text-right text-xxl leading-[0.65] my-0 stroked appear-right hidden md:block lg:hidden text-[#111010] dark:text-white" dir="rtl">.FOKKK</h1>
                        <hr className="h-[3px] bg-black dark:bg-white mt-20" />
                    </div>
                    <div className="mt-2 overflow-hidden">
                        <div className="w-32 md:w-64 h-fit hidden md:block appear-left">
                            <Barcode />
                        </div>
                        <h2 className="text-left font-bold text-2xl md:hidden pt-0 appear-right text-[#111010] dark:text-white">EST. 2005</h2>
                    ...
                    <div className="mt-2">
                        <h2 className="text-right font-bold text-2xl hidden md:block appear-right text-[#111010] dark:text-white">EST. 2005</h2>
                        <CoolMesh />
                        <Navigation />
                    </div>
                    <div className="pt-16 px-0 md:px-3 grid grid-cols-2 w-full md:absolute bottom-3">
                        ...
                        <h4 className="text-[16px] text-[#111010] dark:text-white">[MADE IN HONG KONG]</h4>
                        <h4 className="text-right text-[#111010] dark:text-white">{getTime()}</h4>
                    </div>
                </div>
