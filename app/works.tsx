...
export default function Works() {
    ...
    return (
        <>
            ...
            <div ref={ref} id="work" className="col-span-full mt-24 md:mt-10 mb-24 md:mb-0 w-full p-3 md:p-0 grid grid-cols-9 gap-6 md:auto-rows-[11rem] min-h-screen md:min-h-[720px] lg:min-h-[1080px] ">
                <div className="relative col-span-full md:col-start-8 md:col-span-1 md:row-start-1 md:row-span-1">
                    ...
                    <h1 className={`md:hidden text-5xl leading-[1] font-bold text-[#111010] dark:text-white ${isVisible ? 'fade-in' : 'opacity-0'}`}>專案</h1>
                </div>
                ...
                <div className="col-span-full md:col-start-5 md:col-span-3 md:row-start-4 md:row-span-4 mb-12 ">
                    <ProjectCard link={"https://github.com/doughnut923/futu_portfolio"} title={"FutuPort"} description={"Futu Portfolio Tracker & Optimizer"} image={"futu.png"} delay={0} />
                </div>
                <div className="col-span-full md:col-start-2 md:col-span-3 md:row-start-7 md:row-span-4 mb-12">
                    <ProjectCard link={"https://github.com/doughnut923/Blossom"} title={"Blossom"} description={"A personal project where I designed a keyboard case inspired from the Alice layout."} image={"blossom.png"} delay={0} />
                </div>
            </div>
        </>
    )
