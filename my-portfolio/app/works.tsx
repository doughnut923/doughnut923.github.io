...
export default function Works() {
    ...
    return (
        <>
            ...
            <div className="relative md:grid col-span-full mt-10 grid-cols-1 md:grid-cols-9 md:gap-6 h-screen w-full">
                ...
                <div className="col-span-6 md:grid md:grid-cols-6 md:gap-6 h-[60vh] mt-32 md:mt-52">
