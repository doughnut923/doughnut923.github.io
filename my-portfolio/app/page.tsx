    ...
    <>
      <section className="md:grid col-span-full grid-cols-1 md:grid-cols-9 md:gap-6 relative h-screen w-full">
        ...
        <div className="mt-5 md:hidden h-fit">
          <h1 className="font-bold mb-4 text-right text-7xl line-h leading-[0.65] my-0" dir="rtl">JONAS</h1>
          <h1 className="font-bold mb-2 text-left text-7xl leading-[0.65] my-0" dir="ltr">FOKKKK.</h1>
        </div>
        <div className="top-24 md:top-0 p-3 md:py-4 md:col-span-4 h-96 w-full md:w-auto md:h-screen absolute z-[-1] md:relative">
          <img
            src="/profile.jpg"
            alt="Profile Picture"
        ...
        <div className="mt-[20rem] md:mt-0 md:col-span-5 h-full">
          <div className="p-3 md:grid md:grid-cols-2 md:h-full h-fit relative grid-flow-row auto-rows-max">
            ...
            <div className="mt-2">
              <Barcode />
              <h2 className="text-left font-bold text-2xl md:hidden pt-0">EST. 2005</h2>
              <p className="w-64 text-justify leading-[1]">Your software dev, ui/ux designer, photographer, traveler, final boss of compsci (not really), average autism enjoyer.</p>
              <img className="mt-2 h-32 grayscale hidden md:block hover:h-56 transition-all" src="https://i.pinimg.com/originals/94/f0/65/94f0653d30bd368e5dfe492f0f60e01e.gif" alt="loading..." />
            </div>

            <div className="mt-2">
              <h2 className="text-right font-bold text-2xl hidden md:block">EST. 2005</h2>
              <CoolMesh />
              <Navigation />
            </div>
